...
class OrganisationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post organisations_url, params: { organisation: { address: @organisation.address, city: @organisation.city, country: @organisation.country, description: @organisation.description, name: @organisation.name, postcode: @organisation.postcode, service_type: @organisation.service_type, telephone: @organisation.telephone, user_id: @organisation.user_id } }
    end
  ...
  test "should update organisation" do
    patch organisation_url(@organisation), params: { organisation: { address: @organisation.address, city: @organisation.city, country: @organisation.country, description: @organisation.description, name: @organisation.name, postcode: @organisation.postcode, service_type: @organisation.service_type, telephone: @organisation.telephone, user_id: @organisation.user_id } }
